...
const orderSchema = new mongoose.Schema({
    ...
    deliveryDate: { type: String, requiredd: true, trim: true },
    ...
    userName: { type: String, requiredd: true, trim: true },
    city: { type: String, requiredd: true, trim: true },
    address: { type: String, requiredd: true, trim: true },
    phoneNo: { type: Number, requiredd: true, trim: true },
    pincode: { type: Number, requiredd: true, trim: true },
    alternatePhoneNo: { type: Number, requiredd: true, trim: true },
